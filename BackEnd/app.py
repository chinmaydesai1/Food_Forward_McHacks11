...
def reset_meal_and_snack():
    db.db.Student.update_many(
        {}, {"$set": {"meal": {"meal": False}, "snack": 0}})


scheduler.add_job(func=reset_meal_and_snack, trigger="cron",
                  hour=0, minute=0)  # schedule reset
